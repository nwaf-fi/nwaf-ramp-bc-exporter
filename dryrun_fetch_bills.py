...
def main():
    ...
    print(f'Fetching approved bills from {start_str} to {end_str}...')
    bills = client.get_bills(status='APPROVED', start_date=start_str, end_date=end_str, page_size=cfg['ramp'].get('page_size',200))
