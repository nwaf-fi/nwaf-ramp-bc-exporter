...
def main():
    ...
    print(f'Fetching APPROVED bills from {start_str} to {end_str} (read-only)...')
    bills = client.get_bills(status='APPROVED', start_date=start_str, end_date=end_str, page_size=100)
